...
namespace Ideal.Configuration
{
    ...
    {
        private static STSConfigurationElement _instance;
        public static STSConfigurationElement Instance => 
            _instance ??
                (_instance = (STSConfigurationElement) ConfigurationManager
                    .GetSection("Ideal/sts"));
